...
open class API {
    ...
    suspend fun borrowerCheckout(borrowerUID: String, ownerships: CheckoutRequest): borrowerCheckedOutResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun borrowerCheckIn(ownerships: CheckoutRequest): borrowerCheckedOutResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun ownershipCreate(ownershipCreateRequest: OwnershipCreateRequest): OwnershipResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun ownershipQuantity(changeType: String, amount: Int, ownershipUID: String): OwnershipResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun ownershipSetLocation(ownershipUID: String, locationQR: String): CommonResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun ownershipSearch(searchRequest: SearchRequest): ownershipSearchResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun ownershipEdit(ownershipEditRequest: OwnershipEditRequest, uid: String): CommonResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun scannerBarcode(barcode: String): ScannerBarcodeResponse = withContext(Dispatchers.IO){
    ...
    suspend fun locationEdit(locationEditRequest: LocationEditRequest, locationUID: String): CommonResponse = withContext(
        Dispatchers.IO){
    ...
    suspend fun ping(hostname: String, port: String): CommonResponse = withContext(
        Dispatchers.IO){
